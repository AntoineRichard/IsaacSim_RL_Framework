...
class DreamerImg2ImgRSSMPhysics(DreamerImg2ImgNoPhysics):
  ...
  def export4ROS(self, path="latest"):
    ...
    self._env_dynamics.save(os.path.join(self._c.logdir,'env_dynamics_weights.pkl'))
    self._phy_dynamics.save(os.path.join(self._c.logdir,'phy_dynamics_weights.pkl'))
