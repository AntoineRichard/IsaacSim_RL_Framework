...
if __name__ == "__main__":
    ...
    utils.createObject('/World/ground_plane', stage, nucleus_server + '/RLEnvironments/Assets/LakeBeds/groundplane.usd', False)
    ...
    omni.usd.get_context().save_as_stage(nucleus_server + "/RLEnvironments/Worlds/Lakes/StandaloneLakesGround/Lake_"+str(args.lake_id)+".usd", None)
