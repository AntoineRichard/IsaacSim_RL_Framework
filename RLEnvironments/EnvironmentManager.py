def getEnvironment(environment_name, task_name, robot_name, world_specs={}, env_specs={}, task_specs={}):
    ...
    if robot_name == "heron":
        from RLEnvironments.HeronWrapper import HeronWrapper as RobotLoader
    else:
        raise ValueError("unknown robot: "+str(robot_name))

    if environment_name=="lake":
        from RLEnvironments.LakeEnvironment import SingleLakeEnvironment as WorldLoader
    ...
    if task_name=="follow_shore_velocity_goal":
        from RLEnvironments.FollowShoreTask_VelocityGoal import FollowShoreVelocityGoal as Task
        ...
        from RLEnvironments.FollowShoreTask_FixedVelocity import FollowShoreFixedVelocity as Task
        needed_task_specs = ["ideal_dist", "min_dist", "max_dist",
