...
if __name__ == "__main__":
    ...
    #sys.path.insert(0,'/home/gpu_user/.local/share/ov/pkg/isaac_sim-2021.1.1/python_samples/Buoyancy')
    #import UnderWaterObject
    #print(UnderwaterObject.__dict__())
    nucleus_server = utils.get_nucleus_server()
    asset_path = nucleus_server + "/LakeSimulation/heron.usd"
    ...
    #UWO = UnderWaterObject.UnderWaterObject(stage, PhysXIFace)
    #dc = _dynamic_control.acquire_dynamic_control_interface()

    def physics_update(dt: float):
        getPose(PhysXIFace,'/heron/dummy_link')
        #UWO.Update(dt)
    ...
    UWO = UnderwaterObject(stage, PhysXIFace)
