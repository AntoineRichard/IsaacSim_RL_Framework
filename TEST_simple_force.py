...
if __name__ == "__main__":
    ...
    from python_samples.Buoyancy.PhysxUtils import Quaternion2RotationMatrix, getRelativeLinearVel
    ...
    def physics_update(dt: float):
        ...
        print(it, it*1/120.0, t, getRelativeLinearVel(rigidbody,rot_mat_inv))
        t += dt
        it += 1
